...
import { verifySessionMatch } from '../../../middlewares/sessionMatchMiddleware';
...
router.get('/download-selfies/:sessionId', authenticateUser, verifySessionMatch, asyncHandeler(sessionControllers.downloadSessionSelfies));

router.post('/upload-logo/:sessionId', authenticateUser, verifySessionMatch, uploadMiddleware.single("logo", {
